...
ALTER TABLE dept_manager ADD FOREIGN KEY (emp_no) REFERENCES departments(emp_no);
...
ALTER TABLE employees ADD FOREIGN KEY (emp_title_id) REFERENCES titles(titles_id);
...
ALTER TABLE titles ADD PRIMARY KEY (titles_id);